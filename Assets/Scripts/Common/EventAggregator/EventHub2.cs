...
{
    public abstract class EventHub<TEvent, TValue1, TValue2> : IAggrEvent
        where TEvent : EventHub<TEvent, TValue1, TValue2>, IAggrEvent
    {
        ...
        public void Publish(TValue1 value1, TValue2 value2)
        {
            _eventAggregator.Publish<TEvent, TValue1, TValue2>(value1, value2);
        }
